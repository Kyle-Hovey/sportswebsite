...
<html lang="en">
  ...
  <body>
    ...
    <div>
      <p> <a href="signup.php" class="btn btn-success"><span class="glyphicon glyphicon-user"></span> Sign Up</a> or <a href="login.php" class="btn btn-success"><span class="glyphicon glyphicon-log-in"></span> Login</a></p>
    </div>
